...
var clutter = "";   // blank string define kiya hai

document.querySelector("#page2>h1").textContent.split(" ").forEach(function (val) {  // #page2>h1 mein jitne bhi word hai usko single word mein split kiya hai and for each function ka use kiya hai


    clutter += `<span> ${val}</span>`  // clutter jo variable banaya hai upar usmein val jismein har word store honga with the help of forEach loop wo clutter mein ek ek karke add honga 


    document.querySelector("#page2>h1").innerHTML = clutter; // isse #page2>h1 mein har word single display honga use inspect to see the changes in html file
})
...
// same code copy kiya hai
var clutter = "";

document.querySelector("#page4>h1").textContent.split(" ").forEach(function (val) {
...
document.querySelector("#page6>h1").textContent.split(" ").forEach(function (val) {
